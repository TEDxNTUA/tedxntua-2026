...
type Props = {
  member: Member;
  /** Tailwind classes for the outer container (size, rounded, bg, border, shadow, etc.) */
  containerClassName?: string;
  /** Inline styles for the outer container (use for non-Tailwind sizes like MEMBER_PHOTO_WIDTH) */
  containerStyle?: React.CSSProperties;
};

export default function MemberPhoto({ member, containerClassName = "", containerStyle }: Props) {
