...
import { allSideHappenings } from "../infoDatabase";
  ...
  return (
    <section className={styles.modalDescription}>
      <h3 className={styles.modalDescriptionName}>
        {formatUppercaseNoAccents("Περιγραφή")}
      </h3>
...
function buildPerformerCard(performer, index) {
  ...
  return {
    ...
    name: performer.artName || performer.name || performer.title || "",
    profession: capitalizeSegments(performer.profession || "Side Event"),
...
const performerCards = allSideHappenings.map(buildPerformerCard).filter(Boolean);
    ...
    >
      ...
      >
        ...
        <div className={styles.modalContent}>
          <p className={styles.modalEyebrow}>Side Events</p>
  ...
  return (
    <section className={styles.page} data-modal-open={activePerformer ? "true" : "false"}>
      <div className={styles.backdrop} aria-hidden="true">
        <Image
          src={withBasePath("/gradient_backgrounds/gradient_green.svg")}
          alt=""
          fill
          priority
