...
export default function ProgramPage() {
  return (
    <div>
      ...
      <section id="speakers" className="min-h-[70vh] py-20 scroll-mt-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-semibold mb-6">Speakers</h2>
          <p className="text-gray-700">Speaker list and bios will be published here.</p>
        </div>
      </section>
      ...
      <section id="professional-workshops" className="min-h-[70vh] py-20 scroll-mt-24 bg-gray-50">
        <div className="container mx-auto px-4">
      ...
      <section id="experience-workshops" className="min-h-[70vh] py-20 scroll-mt-24">
        <div className="container mx-auto px-4">
      ...
      <section id="side-happenings" className="min-h-[70vh] py-20 scroll-mt-24 bg-gray-50">
        <div className="container mx-auto px-4">
